    ...
    return (
        ...
        <div className="teacher">
            <div className="teacherTitleContainer">
                <h3 className="teacherTitle">Candidate Details</h3>
            ...
            <div className="teacherContaine">
                <div className="teacherShow">
                    ...
                    <div className="userShowBottom">
                        ...
                        <div className="userShowInfo">
                            <LocationSearching className="userShowIcon" />
                            <span className="userShowInfoTitle">Signature: <img src={profile} alt="" className="userShowImage"></img> </span>
                        </div>
                        <span className="userShowTitle">Exam Specifics</span>
                        <div className="userShowInfo">
                            <PhoneAndroid className="userShowIcon" />
                            <span className="userShowInfoTitle">Number Of Attepms : 3</span>
                        </div>
                        <div className="userUpdateItem">
                            <div className="gender">
                                ...
                                <input className="radio"
                                    type="radio"
                                    name="category" id="Internal" value="Internal"
                                />
                                <label for="interna">Internal</label>
                                <input className="radio"
                                    type="radio"
                                    name="category" id="external" value="externa"
                                />
                                <label for="externa">External</label>
                            </div>
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">
                                Guardian Name :<Link> patrick mabziness</Link></span>
                            ...
                            <div className="userUpdateLeft">
                                ...
                                <div className="gender">
                                    ...
                                    <input className="radio"
                                        ...
                                        name="gender" id="male" value="male"
                                    />
                                    <label for="male">Internal</label>
                                    <input className="radio"
                                        type="radio"
                                        name="gender" id="female" value="female"
                                    />
                                    <label for="female">External</label>
                                </div>
                                <div className="userUpdateItem">
                                    <label className="labelclass">Number Of Attempts  </label>

                                    <select className="newUserSelect" name="active" id="active">
                                        <option value="chich1">1</option>
                                        <option value="chich2">2</option>
                                        <option value="chich2">3</option>
                                        <option value="chich2">4</option>
                                        <option value="chich2">5</option>
                                ...
                                <div className="userUpdateItem">
                                    ...
                                    <select className="newUserSelect" name="active" id="active">
                                        <option value="chich1">Frola luka</option>
                                        <option value="chich2">Luhanga luhanga</option>
