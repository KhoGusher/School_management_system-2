...
import { addCandidate } from '../../../../Controllers/Admin';
         ...
         return (
              <Formik
                  ...
                  onSubmit={(values, { setSubmitting, resetForm }) => {
                    ...
                    this.props.goAddCandidate(values);
                ...
                let form = (
                    <div className="teacherUpdate">
                        <div className="userUpdate">
                            <span className="userUpdateTitle">New candidate dashboard</span>
                            ...
                            return (
                                ...
                                {form}
                                { this.props.addedCandidateVAR ? 
                                <div>
                                <p>Identity: {this.props.addedCandidateVAR.updatedSignature[0].identity}</p>
                                <p>Password: {this.props.addedCandidateVAR.password}</p>
                                </div>: null
                                }
                              </div>
                            );
...
const mapStateToProps = state => {
    return {
      ...
      addedCandidateVAR: state.Admin.addedCandidateVAR
    }
  }

  const mapDispatchToProps = dispatch => {
   return {
      goAddCandidate: (values) => dispatch( addCandidate(values))
   };
  };
