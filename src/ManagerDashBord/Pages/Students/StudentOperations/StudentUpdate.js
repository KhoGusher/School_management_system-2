...
import { editStudent } from '../../../../Controllers/Admin';
                    ...
                    <div className="teacherUpdate">
                        <div className="userUpdate">
                            ...
                            <form className="userUpdateForm" onSubmit={handleSubmit}>
                                ...
                                if(this.props.editedStudentVAR){
...
const mapStateToProps = state => {
    return {
      ...
      editedStudentVAR: state.Admin.editedStudentVAR
    }
  }

  const mapDispatchToProps = dispatch => {
   return {
      goEditStudent: (values) => dispatch( editStudent(values))
   };
  };
